...
public class BookFlight extends JFrame implements ActionListener {
    ...
    JButton bookflight, fetchButton, flight, closeButton;
    ...
    public BookFlight() {
        ...
        lblpnr.setBounds(60, 580, 150, 25);
        lblpnr.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lblpnr);
        
        tfpnr = new JTextField();
        tfpnr.setBounds(220, 580, 150, 25);
        tfpnr.setEditable(false);  // Read-only but copyable
        add(tfpnr);
        ...
        closeButton.setBounds(220, 620, 150, 25);
